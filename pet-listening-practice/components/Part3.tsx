...
const Part3: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <p className="text-slate-600 mb-6">Listen to the radio presenter and fill in the missing information.</p>
      ...
      <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
        <h2 className="text-2xl font-bold text-slate-800 mb-6 border-b pb-4">Summer Activities</h2>
