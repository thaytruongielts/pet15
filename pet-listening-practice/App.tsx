            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-600 mb-6">
                    Seven multiple choice questions. Listen to short audio clips and choose the correct picture (A, B, or C).
                  </p>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-600 mb-6">
                    Six gap-fill questions. Listen to a longer monologue and fill in the missing information in the notes.
                  </p>
